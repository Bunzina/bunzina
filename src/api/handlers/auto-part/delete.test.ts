...
import { deleteAutoPartHandler } from './delete';

describe('delete auto part handler', () => {
  beforeEach(() => {
    mockDb.mockImplementation(() => Promise.resolve([]));
  });

  test('should delete an auto part by id', async () => {
    ...
    const response = await deleteAutoPartHandler(context);
