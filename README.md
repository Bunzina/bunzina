...
Se houver qualquer dúvida ou problema durante a execução do projeto, consulte também o [README da Fase 1](docs/READMEs/phase-1.md), que contém a documentação histórica e mais detalhes do fluxo original.
