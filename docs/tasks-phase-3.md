...
- [x] Integrar a aplicação com uma ferramenta de monitoramento e observabilidade.
...
- [x] Monitorar a latência das APIs.
- [x] Monitorar o consumo de CPU e memória do Kubernetes.
- [x] Monitorar healthchecks e uptime.
- [x] Implementar alertas para falhas no processamento de ordens de serviço.
...
- [x] Criar o dashboard de volume diário de ordens de serviço.
- [x] Criar o dashboard de tempo médio de execução por status.
...
- [x] Criar o dashboard de erros e falhas nas integrações.
- [x] Configurar dashboards e alertas na plataforma escolhida.
